# -*- coding: utf-8 -*-
import clr
clr.AddReference('System.Windows.Forms') #из этой библиотеки берем классы формы Form и кнопки Button
clr.AddReference('System.Drawing') #из этой библиотеки берем тип Point и тип Size
